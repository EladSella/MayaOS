"""
invoke_dana.py — Standalone runner for Dana (Appointments Agent).

Usage:
  python invoke_dana.py "your message"
  python invoke_dana.py --status
  python invoke_dana.py --inbox
  python invoke_dana.py --send <to> <intent> <json_data>
  python invoke_dana.py --process-inbox
"""
