"""
invoke_lian.py — Standalone runner for Lian (Energy Optimization Agent).

Usage:
  python invoke_lian.py "your message"
  python invoke_lian.py --status
  python invoke_lian.py --inbox
  python invoke_lian.py --send <to> <intent> <json_data>
  python invoke_lian.py --process-inbox
"""
...
AGENT_ID = "lian"
ROLE_TITLE = "Energy Optimization Agent"
